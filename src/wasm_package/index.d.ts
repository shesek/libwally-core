...
export type Ref_words = OpaqueRef<'words'>;
export type Ref_ext_key = OpaqueRef<'ext_key'>;
export type Ref_wally_map = OpaqueRef<'wally_map'>;
...
export type Ref_wally_tx_witness_stack = OpaqueRef<'wally_tx_witness_stack'>;
...
export function bip39_mnemonic_to_seed(mnemonic: string, passphrase: string): Buffer;
...
export function psbt_extract(psbt: Ref_wally_psbt): Ref_wally_tx;
...
export function tx_elements_issuance_generate_entropy(txhash: Buffer|Uint8Array, index: number, contract_hash: Buffer|Uint8Array): Buffer;
